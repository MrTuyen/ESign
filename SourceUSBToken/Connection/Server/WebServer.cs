    ...
    public class WebServer : IDisposable
    {
        ...
        private Stream GetStream(TcpClient tcpClient)
        {
            ...
            try
            {
                ...
                //sslStream.AuthenticateAsServer(_sslCertificate, false, SslProtocols.Default, true);
                sslStream.AuthenticateAsServer(_sslCertificate, false, (SslProtocols)3072, true); // For browser does not support TLS 1.0, 1.2 and SSL. (SslProtocols)3072 = Tls12
